...
def test_all_sensors():
    ...
    try:
        ...
        if weather_data:
            ...
            print(
                f"  Temperature: {weather_data['temperature_celsius']}°C ({weather_data['temperature_celsius'] * 9/5 + 32:.1f}°F)"
            )
            print(
                f"  Feels like: {weather_data['feels_like_celsius']}°C ({weather_data['feels_like_celsius'] * 9/5 + 32:.1f}°F)"
            )
